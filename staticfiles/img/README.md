![Coffee Blog Logo](static\img\read-img\main.jpg)
...
Homepage:
![Homepage](static\img\read-img\1.Homepage_Wireframe.png)

Blog Post detail:
![Post Detail](static\img\read-img\2.PostDetail_Wireframe.png)

Register on Mobile:
![Register Mobile](static\img\read-img\3.Register-Phone_Wireframe.png)

Login on Mobile:
![Login Mobile](static\img\read-img\4.Login-Phone_Wireframe.png)

To plan the structure of the blog I made a flowchart with DrawSQL, which shows all functionality.  

![Flowchart DrawSQL](static\img\read-img\ERD.png)
...
![Colour palette](static\img\read-img\color.palette.png)<br>
...
- **Header**
    ...
    ![header - signed out](static\img\read-img\header.signed.out.png)
   ...
   - A logged-in user sees navigation elements to "Home", "Logout" and "More" with the drop-down menu showing showing "About Us", "Contact Us" and "My favorites".<br>
     ![header - signed in](static\img\read-img\header.signed.in.png)
...
![header - search](static\img\read-img\search.message.png)
...
- In the mobile view, the logo is on the left side up and a drop-down menu shows on the right side. When clicked, it opens under the header, pushing down the content. It contains the links to
      ...
      ![header - mobile view](static\img\read-img\header.mobile.view.png)
...
- **Main section - Home page**
    ...
    - Each post is displayed with an image, the post's title, date and time of the post and the name of the author.
     ![Main part of the homepage](static\img\read-img\Home.page.png)<br>
    ...
    ![Main part of the homepage bottom](static\img\read-img\main.previous.next.png)<br>
...
- **Register**
    ...
    ![Sign up](static\img\read-img\signup.png)<br>
...
- **Sign in**
    ...
    ![Sign in](static\img\read-img\signin.png)<br>
...
- **Post detail - Top of the page**
    ...
    ![Post detail](static\img\read-img\post.detail.desktop.png)<br>
    ![Post detail on mobile](static\img\read-img\post.detail.mobile.png)<br>
...
- **Favorites**
    ...
    ![Favorites toggle](static\img\read-img\favorites.red.png/)<br>
    ...
    - Upon clicking on "My Favorites" in the navbar drop-down menu, a new page opens up showing all the posts in the logged-in users favorites  
      ...
      ![Favorites page](static\img\read-img\favorits.list.png) 
...
- **Post detail - Comment section with CRUD**
    ...
    ![Log in to comment](static\img\read-img\login.to.comment.png)
    ...
    - The logged-in user can also read comments, and in addition can submit comments and edit or delete their own:
      ...
      ![Comment with pending approval](static\img\read-img\comment.pending.approval.png)
      ...
      ![edit Delete comment](static\img\read-img\edit.delete.comment.png)<br>
...
- **About Us Page**
    ...
    ![About Us page](static\img\read-img\about.us.png)
    ...
    ![Contact Us link](static\img\read-img\contact.us.png)
...
- **Contact Us Page**
    ...
    - All users can click on "Contact Us" in the "More" dropdown-box or click on the "contact us !" button on the "About Us" page to open the "Contact us" page.
     ...
     - The page shows a contact form, where the user can leave his name, email address and a feedback message or inquiry.
       ...
       ![Contact Us page](static\img\read-img\contact.us.page.png)

     - If the user clicks on the "send" button, a message confirms that he successfully submitted his feedback.

       ![thank you for your message](static\img\read-img\thank.you.for.your.message.png)<br>
...
- **Sign Out**
    ...
    - On this page, the user is asked whether they really want to sign out, and to confirm his intention.
      ![Sign out](static\img\read-img\sign.out.confirm.png)<br>
    - Upon confirming, the user is signed out and a feedback message is displayed to the user, informing them that their action was successful.
      ...
      ![Success message](static\img\read-img\success.signed.out.png)<br>
...
- **Footer**
    ...
    ![Footer](static\img\read-img\footer.png)
